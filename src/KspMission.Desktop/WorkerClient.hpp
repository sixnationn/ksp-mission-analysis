...
enum class WorkerResultKind { screened_seed, screened_route, fixed_impulse_evaluation, bounded_shooting };
...
private:
    ...
    std::size_t shooting_total_=0,last_completed_probes_=0,shooting_progress_events_=0;
