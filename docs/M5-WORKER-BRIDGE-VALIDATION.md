...
This establishes process/protocol behavior on the Windows host. Ubuntu native CI, GTK main-context dispatch, close-window responsiveness, rendered view, runtime route search, save/reload and reports remain open.
